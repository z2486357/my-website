...
export class ProfileStoreService {
  ...
  experience = {
    ibm: {
      ...
      type: "work",
      detail: false,
      description: ["- Use Power App and Microsoft Dynamic 365 to develop the sketch of the app",
        "- Use HTML/CSS/Javascript for the customized code of front-end",
        "- Use C# for the customized code of back-end"],
    },
    free: {
      name: "free",
      ...
      type: "work",
      detail: false,
      description: ["- Build the web application to collect the potential client data",
        "- Use Angular to build the front-end of the website",
        "- Use Node.js and Express for back-end"],
    },
    enfotech: {
      name: "enfotech",
